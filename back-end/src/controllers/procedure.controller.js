...
//   doc.text('Amount (Rs.)', tableX + col1Width + col2Width + col3Width + 5, yPos + 6, { width: col4Width - 5, align: 'right' });
...
//     doc.text(price.toLocaleString('en-IN'), tableX + col1Width + col2Width + col3Width + 5, yPos + 4, { width: col4Width - 5, align: 'right' });
...
//       doc.text('Procedure Name', tableX + col1Width + 5, yPos + 6, { width: col2Width - 5, align: 'left' });
//       doc.text('Category', tableX + col1Width + col2Width + 5, yPos + 6, { width: col3Width - 5, align: 'left' });
//       doc.text('Price (₹)', tableX + col1Width + col2Width + col3Width + 5, yPos + 6, { width: col4Width - 5, align: 'right' });
...
//   // Total label
//   doc.text('GRAND TOTAL', tableX + col1Width + 5, yPos + 6, { width: col2Width + col3Width - 10, align: 'right' });
