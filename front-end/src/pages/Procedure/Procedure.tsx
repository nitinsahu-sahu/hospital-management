...
export default function Procedure() {
  ...
  return (
    <>
      <PageMeta title="Patient Procedure Routine Blood" description="Patient Procedure  data" />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 md:p-6 transition-colors duration-200">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Procedure </h1>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Patient Procedure data</p>
          </div>
