                            ...
                            >
                                <div className="flex items-center justify-between w-full">
                                    ...
                                    <div className="flex items-center gap-2 ml-4 flex-shrink-0">
                                        ...
                                        <svg
                                            className={`w-5 h-5 text-gray-400 transition-transform duration-300 ${expandedPrescriptionId === prescription._id ? 'rotate-180' : ''}`}
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                    ...
                                    <div className="p-6 space-y-6">
                                                    ...
                                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 ml-10">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm font-medium text-gray-900 dark:text-white">{medication.dosage}</p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                                            <div className="grid grid-cols-2 gap-4 text-xs text-gray-500 dark:text-gray-400">
                                                ...
                                                {prescription.updatedBy && prescription.updatedBy._id !== prescription.createdBy?._id && (
